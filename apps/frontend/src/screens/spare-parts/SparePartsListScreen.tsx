...
import { Heading1, BodyText, Button, Card, InputField } from '@components/ui';
import { Plus, AlertCircle, Package, Search } from 'lucide-react';
import { 
  SparePartCard, 
    ...
    content = (
      <div className="space-y-6">
        ...
        <div className="flex items-center gap-2 text-sm text-muted-foreground">
          ...
          <span>/</span>
          <span className="text-foreground">{vm.t('spareParts.breadcrumb')}</span>
        </div>
        ...
        <Card className="p-12">
          <div className="flex flex-col items-center text-center space-y-4 max-w-md mx-auto">
            ...
            <Button variant="filled" onPress={vm.actions.handleCreateNew} className="mt-4">
      ...
      <div className="space-y-4">
        ...
        <div className="relative">
          ...
          <InputField
            ...
            onChangeText={vm.actions.handleSearchChange}
            className="pl-10"
          />
        </div>
