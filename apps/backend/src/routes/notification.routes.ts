 ...
 * Endpoints para gestión de notificaciones de usuario
 * Todas las rutas requieren autenticación y validan ownership
 * 
 ...
 *         description: Unauthorized - Missing or invalid authentication
 *       403:
 *         description: Forbidden - User trying to access another user's count
 *       404:
 *         description: User not found
 *       500:
 *         description: Internal server error
